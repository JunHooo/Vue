...
<!--        <el-input v-model="ruleForm.studentid" oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>-->
<!--      </el-form-item>-->

<!--      <el-form-item label="学生成绩" prop="grade">-->
<!--        <el-input v-model="ruleForm.grade" oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>-->
<!--      </el-form-item>-->

<!--      <el-form-item label="卷面分" prop="papergrade">-->
<!--        <el-input v-model="ruleForm.papergrade" oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>-->
<!--      </el-form-item>-->

<!--      <el-form-item label="平时分" prop="performgrade">-->
<!--        <el-input v-model="ruleForm.performgrade" oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>-->
<!--      </el-form-item>-->

<!--      <el-form-item label="学分" prop="credit">-->
<!--        <el-input v-model="ruleForm.credit" oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>-->
<!--      </el-form-item>-->

<!--      <el-form-item label="绩点" prop="gradepoint">-->
<!--        <el-input v-model="ruleForm.gradepoint" oninput="value=value.replace(/[^0-9.]/g,'')"></el-input>-->
<!--      </el-form-item>-->
<!--      <br/>-->
<!--      <el-form-item>-->
      ...
      <el-form :inline="true" style="width: 80%" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px"
        ...
        <el-form-item label="开课学院" prop="college">
          <el-select v-model="ruleForm.college" placeholder="请选择学院">
            ...
            <el-option label="体育院" value="体育院"></el-option>
          </el-select>
        </el-form-item>
        ...
        <el-form-item label="考试科目" prop="classname">
          <el-select v-model="ruleForm.classname" placeholder="请选择考试科目">
