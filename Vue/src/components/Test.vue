<template>
  <div id="app">
    <div class="background">
      <img src="../assets/image/bg10.jpg" width="100%" height="110%" alt=""/>
    </div>
    ...
    <el-row type="flex" justify="center">
      <el-col :span="8">
        <el-card class="el-card" shadow="always" style="">
          <h1 style="color: white">统一身份认证登录</h1>
          <!--          横线-->
      ...
      { required: true, message: '密码不能为空'},
            ...
            >
              <el-input placeholder="请输入密码" v-model="nameValidateForm.password" autocomplete="off" show-password
                        clearable></el-input>
            </el-form-item>
            <el-form-item>
<!--              <el-col>-->
<!--                <el-link :underline="false" href="http://localhost:8080/ForgetPassword"-->
<!--                         style="display: flex;float: right;margin-right:20px;font-size: large;font-weight: bold"-->
<!--                         type="danger">忘记密码？-->
<!--                </el-link>-->
<!--              </el-col>-->
