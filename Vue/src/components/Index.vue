  ...
  <div id="app">
    ...
    <el-container>
      <el-header style="text-align: right; font-size: 12px;height: 130px">
        ...
        <span style="font-size: 20px;color: #fff;font-weight: 200;">{{this.$route.query.name}}，同学</span>
      ...
      <el-aside width="200px"  >
        <el-menu @select="handleSelect" style="background-color:rgba(51,51,51,0.1);">
          <el-submenu index="1" >
            ...
            <el-menu-item index="1"><i class="fa fa-id-card" style="margin-right: 10px"></i>基本信息</el-menu-item>
            <el-menu-item index="2"><i class="fa fa-file" style="margin-right: 10px"></i>学籍信息</el-menu-item>
            <el-menu-item index="3"><i class="fa fa-phone-square" style="margin-right: 10px"></i>联系方式</el-menu-item>
            <el-menu-item index="4"><i class="fa fa-anchor" style="margin-right: 10px"></i>成绩信息</el-menu-item>
          </el-submenu>
          <el-submenu index="2">
            ...
            <el-menu-item index="5"><i class="fa fa-tasks" style="margin-right: 10px"></i>查看课程</el-menu-item>
          </el-submenu>
          <el-submenu index="3">
            ...
            <el-menu-item index="6"><i class="fa fa-search" style="margin-right: 10px"></i>查询成绩</el-menu-item>
          ...
          <el-submenu index="4">
            ...
            <el-menu-item index="9"><i class="fa fa-eye" style="margin-right: 10px"></i>查看评价</el-menu-item>
            <el-menu-item index="10"><i class="fa fa-child" style="margin-right: 10px"></i>评价教师</el-menu-item>
          </el-submenu>
        </el-menu>
      </el-aside>
      <el-main>
...
export default {
  ...
  created() {
    const _this=this
    this.$axios.get('http://localhost:8181/info/findById'+id).then(function(resp){
